...
public class AdminServiceImpl implements AdminService,ISeatReservationService {
    ...
    @Autowired
    public AdminServiceImpl(StudyMaterialMapper studyMaterialMapper, SeatReservationMapper seatReservationMapper,StudyTaskMapper studyTaskMapper,StudyArrangementMapper studyArrangementMapper) {
